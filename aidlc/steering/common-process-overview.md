...
**Note**: Similar content exists in common-welcome-message.md (user welcome message) and README.md (documentation). This duplication is INTENTIONAL - each file serves a different purpose:
- **This file**: Detailed technical reference with Mermaid diagram for AI model context loading
- **common-welcome-message.md**: User-facing welcome message with ASCII diagram

...
**CRITICAL**: When performing any phase, you MUST read and use relevant content from the AI-DLC Power steering files using `readSteering` action.
...
**How to load steering files**:
```
Call action "readSteering" with powerName="aidlc", steeringFile="common/process-overview.md"
```
...
1. Load the welcome message using: `readSteering` with powerName="aidlc", steeringFile="common/welcome-message.md"

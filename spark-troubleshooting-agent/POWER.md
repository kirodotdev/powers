...
displayName: "Apache Spark Troubleshooting Agent"
description: "Troubleshoot Spark applications on EMR, Glue, and SageMaker - analyze failures, identify bottlenecks, get code recommendations"
keywords: ["spark", "emr", "glue", "sagemaker", "troubleshooting", "pyspark", "scala", "performance", "debugging", "aws"]
mcpServers: ["sagemaker-unified-studio-mcp-troubleshooting", "sagemaker-unified-studio-mcp-code-rec"]
author: "AWS"
---
...
- **Kiro CLI**: Required for MCP configuration
  - Verify with: `kiro-cli-chat --version`

- **AWS Credentials**: Must be configured
  - Verify with: `aws sts get-caller-identity`
  - Verify this role has permissions to deploy Cloud Formation stacks
  - Identify the AWS Profile the creds are configured to
...
1. Configure the CLI with the `smus-mcp-profile`
    ...
    ```
1. then update the your MCP json configuration file (typically located at `~/.kiro/settings/mcp.json`) with the region.
...
- **troubleshooting-workflows** - Workflows for analyzing failures and performance issues
- **prompt-examples** - Example prompts for effective troubleshooting requests

...
This steering file guides the comprehensive analysis of all business function inputs — requirements, rule dispositions, and discovery artifacts — to produce a single consolidated markdown document (`ddd-analysis.md`). That document serves as the sole input for Phase 2 (DDD bounded context analysis).

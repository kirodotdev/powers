...
- Mentions "no infrastructure" / "don't want to set up / manage / provision anything" / "no EC2" / "no Batch stack" / "managed" / "just run it for me on AWS" → follow [continuous-modernization-aws-managed-execution](workload-continuous-modernization-aws-managed-execution.md). This is the **no-infrastructure** option (AWS-managed fleet); do NOT offer EC2/Batch or a provisioning step for these requests. **Batch/Fargate is NOT the no-infrastructure option** — it still deploys a customer-owned stack.
- Mentions EC2 / "on an instance" → follow [continuous-modernization-ec2-execution](workload-continuous-modernization-ec2-execution.md)
- Mentions Batch / Fargate / "serverless" → follow [continuous-modernization-batch-execution](workload-continuous-modernization-batch-execution.md)
...
- **AWS-managed** -- follow [continuous-modernization-aws-managed-execution](workload-continuous-modernization-aws-managed-execution.md) (no customer infrastructure)
...
[aws-managed](workload-continuous-modernization-aws-managed-execution.md) · [EC2](workload-continuous-modernization-ec2-execution.md) · [Batch](workload-continuous-modernization-batch-execution.md). For choosing a mode, see "Choose Compute" above.
...
backend before starting or reading an analysis. See the [troubleshooting](workload-continuous-modernization-troubleshooting.md)

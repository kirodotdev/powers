...
| Phase | Input | Output | Steering File |
|-------|-------|--------|---------------|
| Download & Workspace Setup | S3 assets | `reimagine-<ts>/` workspace | This file |
| Business Function Analysis | `spec/` folder | `ddd-analysis.md` | `workload-mainframe-reimagine-analysis.md` |
...
Read and follow `workload-mainframe-reimagine-analysis.md`.
...
Read and follow `workload-mainframe-reimagine-ddd.md`.
...
Read and follow `workload-mainframe-reimagine-specgen.md`.

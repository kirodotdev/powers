...
When the user mentions mainframe modernization, COBOL, JCL, or any mainframe-related topic, present the options directly via AskUserQuestion:
...
See `workload-mainframe-reimagine.md` for the complete workflow to download specs and source code, organize a workspace, and begin reimagining.

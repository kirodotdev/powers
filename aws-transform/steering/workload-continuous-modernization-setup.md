...
See [workload-continuous-modernization-security-agent.md](workload-continuous-modernization-security-agent.md) for the full security agent setup (admin) and runtime verification (executor) flow.

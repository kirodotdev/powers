...
Use this template when recording clarification sessions.
...
**Resolution**: [How this clarification was applied to the specification]
...
- FR-XXX: [New requirement added based on clarification]

### Requirements Changed
- FR-XXX: [Original] → [Updated based on clarification]

---

## Session Notes

[Any additional notes about the clarification session, deferred questions, or recommendations for future clarification]

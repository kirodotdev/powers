...
_reads:
  ...
  - agent-advisor-workload-classes.md (for non-agent units)
...
> recommendation into `design.json` inline within `agent-advisor-design.md` (Step 5). This
...
> the phase's completion gate. See `agent-advisor-design.md` § Step 5 for the design.json shape

...
_of_phase: discover
_reads:
  - detected code signals (scanned inline in agent-advisor-discover.md Step 1)
_produces:
...
> `context-signals.json` inline within `agent-advisor-discover.md` (Step 2). This unit records
...
> phase's completion gate. See `agent-advisor-discover.md` § Step 2 for the mapping onto

...
| `.help-strip`                      | compact help CTA (v3 report family uses this; see agent-advisor-report-help-banner.md for a note)     |
...
- **recommendation-report.html** — `agent-advisor-generate-report.md` inlines
...
- **Temporal sections** — Temporal migration content renders as a CONDITIONAL section of
  recommendation-report.html (`agent-advisor-generate-report.md`, gated on
...
- **poc-report.html** — `agent-advisor-poc-report.md`; its file map uses
  `.feat-grid`, its deploy steps use `.timeline`.

The shared "Need help?" CTA: `agent-advisor-report-help-banner.md` documents the full 3-card

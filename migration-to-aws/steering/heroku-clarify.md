...
_fragments:
  - _id: interview
    ...
    _file: heroku-clarify-interview.md
_assemble:
  _file: heroku-clarify-assemble.md
_produces:
  - preferences.json
_advances_to: design
_re_entry_guard:
...
_postconditions:
  ...
  - _validate_json: preferences.json
    _on_failure: _halt_and_inform
  - _assert: "all Validation Checklist items in heroku-clarify-assemble.md pass"
    _on_failure: _halt_and_inform
...
Load `heroku-clarify-interview.md` and follow it. It handles the
...
Load `heroku-clarify-assemble.md` (the phase's assembler) and

...
> `heroku-discover-live-capture.md` wrote to `$MIGRATION_DIR/live-capture/` and maps them
...
The assembler (`heroku-discover-assemble.md`) owns the inventory's structure and the merge

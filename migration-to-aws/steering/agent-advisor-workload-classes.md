...
Agent-class units are scored by `agent-advisor-scoring.py`; everything else resolves HERE.
...
These verdicts feed the same consolidation question as scored units (agent-advisor-orchestrator.md

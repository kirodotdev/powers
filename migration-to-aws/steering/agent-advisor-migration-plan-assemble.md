...
_reads:
  - injected constraints translated from design.json / confirm.json / answers (built inline in agent-advisor-migration-plan.md Step 2)
...
> inline within `agent-advisor-migration-plan.md` (Step 2). It then executes the engine's
...
> phase) are the phase's completion gate. See `agent-advisor-migration-plan.md` § Steps 2–5.

...
_input: workspace
_assemble:
  _file: agent-advisor-intake-assemble.md
_produces:
  - .phase-status.json
...
`agent-advisor-add-capabilities.md` and follow it. Do NOT continue into Discover / Clarify /
...
`agent-advisor-discover.md` — `agent_session` | `batch` | `light_io` |

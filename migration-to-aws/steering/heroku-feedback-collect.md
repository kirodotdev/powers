...
> the assembler (`heroku-feedback-assemble.md`).
...
> so the feature can be re-enabled by removing this gate (here and in heroku-orchestrator.md
...
the assembler (`heroku-feedback-assemble.md`) for the output gate and phase completion.
